...
public class Main extends Application {
    ...
    public void menuPrincipalView(){
        ...
        ("MenuPrincipalView.fxml",625,624);
    ...
    public void programadorView(){
        try{
            PrograViewController prograView = (PrograViewController)cambiarEscena
        ("PrograView.fxml", 600, 300);
    ...
    public void cargoEmpleadosView(){
        try{
            CargoEmpleadosViewController cargoView = (CargoEmpleadosViewController)cambiarEscena
        ("CargoEmpleadosView.fxml", 1034, 582);
    ...
    public void tipoProductoView(){
        try{
            TipoProductoViewController productoView = (TipoProductoViewController)cambiarEscena
        ("tipoProductoView.fxml", 1034, 582);
    ...
    public void ProveedorView(){
            try{
                ProveedorViewController proveedorView = (ProveedorViewController)cambiarEscena
        ("ProveedorView.fxml", 1181,665);
    ...
    public void CompraView(){
        try{
            ComprasViewController compraView = (ComprasViewController)cambiarEscena
        ("ComprasView.fxml", 1034, 582);
    ...
    public void ProductosView(){
        try{
            ProductosViewController producView = (ProductosViewController)cambiarEscena
        ("ProductosView.fxml", 1181, 665);
